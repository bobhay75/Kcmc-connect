...
assert_redirect_to_login timecards '/admin/timecards.php' 'signed-out time-card review redirects to login'
assert_redirect_to_login timecards_export '/admin/timecards-export.php?user=test&start=2026-08-23&end=2026-09-22' 'signed-out time-card CSV export redirects to login'
assert_redirect_to_login timecards_print '/admin/timecards-print.php?user=test&start=2026-08-23&end=2026-09-22' 'signed-out printable time card redirects to login'
