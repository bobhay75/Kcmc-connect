...
<section class="portal-card portal-section invite-delivery" data-invitation-delivery aria-labelledby="inviteDeliveryTitle">
  ...
  <h2 id="inviteDeliveryTitle">Invitation ready — not emailed</h2>
  ...
  <p>Keep this page open until you have copied the invitation. The private link is not shown again after you leave or refresh.</p>
  ...
  <p>Copy the email above, open Gmail, paste it into the message body, verify <strong>To: <?=kcmc_h($delivery['email'])?></strong>, then click <strong>Send</strong>. The private link is not placed in Gmail’s address bar. This page cannot confirm delivery.</p>
