...
<body class="portal-body"><main class="portal-shell portal-narrow">
  ...
  <section class="portal-card">
    ...
    <p class="portal-fine"><strong>Pastor Tony or Pastor Barry signing in for the first time?</strong> A recovery administrator must send each pastor a separate one-time invitation for their verified email address. Use that personal link to create your password, then return here.</p>
    <p class="portal-fine">Every other new member also receives an individual one-time invitation from a KCMC administrator.</p>
  </section>
</main></body></html>
